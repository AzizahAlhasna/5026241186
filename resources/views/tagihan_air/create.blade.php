...
@section('konten')
    ...
    <script>
        function validasiForm() {
            ...
            if (NoMeteran === '' || isNaN(NoMeteran)) {
                Swal.fire({
                    title: "Kesalahan Input Data!",
                    text: "No Meteran wajib diisi dan harus berupa angka",
                    icon: "error"
                });
                return false;
            }
            ...
            if (MaterAkhir === '' || isNaN(MaterAkhir)) {
                Swal.fire({
                    title: "Kesalahan Input Data!",
                    text: "Mater Akhir wajib diisi dan harus berupa angka",
                    icon: "error"
                });
                return false;
            }
