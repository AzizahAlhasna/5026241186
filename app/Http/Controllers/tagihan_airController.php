...
'MaterAkhir' => 'required|integer|min:0',
        ...
        // ✅ TAMBAHAN: Validasi MaterAkhir harus lebih dari MeterAwal + 20
        if ($request->MaterAkhir <= $request->MeterAwal + 20) {
            return back()->withErrors([
                'MaterAkhir' => 'Mater Akhir harus lebih dari Meter Awal + 20.'
            ])->withInput();
        }
